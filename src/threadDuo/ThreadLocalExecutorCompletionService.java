 ...
 * 2，线程单独获取自己线程提交任务的结果
 * */
public class ThreadLocalExecutorCompletionService<V> implements CompletionService<V>{
    ...
    public ThreadLocalExecutorCompletionService(Executor executor) {
        if (executor == null)
